...
export default function WebsiteDesign() {
  ...
  return (
    <div className="min-h-screen bg-black text-[#f5f5f5]">
      <SEO
        title="Website Design | Apex Fusion Studios"
        description="Premium marketing websites engineered for clarity, conversion, performance, and long-term brand authority."
        path="/website-design"
      />
      ...
      <main id="main" className="pt-28 px-8 lg:px-16">
        <div className="mx-auto max-w-5xl pb-24">
          ...
          <p className="mt-8 text-lg md:text-xl font-light text-neutral-400 leading-relaxed">
            We design and build high-end marketing websites that communicate trust fast,
            load instantly, and convert without gimmicks.
          </p>
            ...
            {[
              {
                ...
                desc: "Positioning, structure, and messaging that makes the value obvious in seconds.",
              },
              {
                title: "Performance + accessibility",
                desc: "Fast pages, clean semantics, keyboard support, and strong contrast by default.",
              },
              {
                title: "Conversion architecture",
                desc: "CTAs, sections, and flow designed to reduce hesitation and increase action.",
              },
              {
                title: "Durable foundations",
                desc: "Maintainable code, clean components, and a site you can extend without rewrites.",
              },
            ].map((c) => (
          ...
          <section className="mt-20 rounded-3xl border border-neutral-800/60 bg-black/30 p-10 backdrop-blur-xl">
            ...
            <div className="mt-10 grid gap-8 md:grid-cols-3">
              {[
                { step: "01", title: "Position", desc: "Define your offer, audience, and message hierarchy." },
                { step: "02", title: "Design", desc: "Craft a clean, premium layout with intentional negative space." },
                { step: "03", title: "Build + ship", desc: "Implement, deploy, and instrument performance + analytics." },
              ].map((s) => (
